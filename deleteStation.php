<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' and isset($_POST["uname"]) and isset($_POST["pword"]) and isset($_POST["sid"]) and (strlen($_POST["uname"]) > 0) and (strlen($_POST["pword"]) > 0) and (strlen($_POST["sid"]) > 0)) {
